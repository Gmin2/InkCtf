      ...
      <div className="flex-1 flex gap-16 overflow-hidden">
        ...
        <div ref={contentRef} className="flex-1 overflow-y-auto pr-12 custom-scrollbar">
          ...
          <div className="flex items-start justify-between mb-6">
            ...
            <a
              href={`#${activeDoc.levelLink}`}
              onClick={(e) => {
                e.preventDefault();
                onClose();
                // Navigate to level - you can emit an event or use router
              }}
          ...
          {/* What You'll Learn */}
          <div className={`p-6 border rounded-sm mb-10 ${
            isLight ? 'bg-blue-50 border-blue-200' : 'bg-blue-500/5 border-blue-500/20'
          }`}>
            <span className={`text-[11px] font-black uppercase tracking-widest mb-4 block ${
          ...
          {/* Real World Example */}
          {activeDoc.realWorld && (
            <div className={`p-6 border-l-4 mb-10 ${
